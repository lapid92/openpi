    ...
    for task_id in tqdm.tqdm(range(num_tasks_in_suite)):
        ...
        for episode_idx in tqdm.tqdm(range(args.num_trials_per_task)):
            ...
            if args.results_jsonl is not None:
                _append_episode_result(
                    pathlib.Path(args.results_jsonl),
                    {
                        "schema_version": 1,
...
def _append_episode_result(path: pathlib.Path, record: dict) -> None:
    """Durably append one machine-readable episode record."""
